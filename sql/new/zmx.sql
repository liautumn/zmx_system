...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,103,'admin','autumn','00','','','1','/profile/avatar/2024/01/17/111_20240117114150A001.jpg','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2024-01-30 10:52:43','admin','2024-01-15 05:14:46','','2024-01-30 02:52:43','管理员'),(4,NULL,'user9','user9','00','408766067@qq.com','16638808906','1','','$2a$10$eB7hZwdz4shTkfEJRyrcWOM7sdaI5udqyZ2BfedrOAnL2dHHuyt/C','0','0','127.0.0.1','2024-01-30 10:30:12','','2024-01-25 08:19:27','','2024-01-30 02:30:11',NULL),(5,NULL,'user1','user1','00','1060590974@qq.com','16638808906','0','','$2a$10$JL6okOdIma5eT.89AlImXuYclPeZlMmpZlk0msBitgLL/HNMzQwBu','0','0','127.0.0.1','2024-01-30 10:52:57','','2024-01-26 02:18:52','','2024-01-30 02:52:57',NULL),(6,NULL,'user2','user2','00','1060590974@qq.com','16638808906','0','','$2a$10$LQkSEdDSqiPQkwmx6QavsOMo.IvPna4OCTsXqEH8CkRq3woiKArW.','0','0','',NULL,'','2024-01-26 04:33:24','',NULL,NULL),(7,NULL,'user3','user3','00','1060590974@qq.com','16638808906','0','','$2a$10$8W3HfATElrOZ9o7bhAohn.NQYbfaYSHWi7tqRuA09yGtSl8eBMNKa','0','0','',NULL,'','2024-01-26 05:27:04','',NULL,NULL),(8,NULL,'user4','user4','00','1060590974@qq.com','16638808906','0','','$2a$10$tpAtlS8IFxXJeQqSsvY4PeSZgTGNHmGe9jySoC/ry1Vl6opEomXYe','0','0','',NULL,'','2024-01-26 05:38:20','',NULL,NULL),(9,NULL,'user6','user6','00','1060590974@qq.com','16638808906','0','','$2a$10$p21kDmGll1TkT1My71hLzeUyQ4ax72jZF5pkN4InJYv1fkPx6XbjG','0','0','',NULL,'','2024-01-26 06:10:55','',NULL,NULL);
...
CREATE TABLE `user_fill_info` (
  ...
  `ext10` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '扩展字段10',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户填报信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_fill_info` VALUES (58,5,'1','0','1','0','2024-01-25','2024-01-30','1','16638808906','1','<p>1</p>','4','<p>1</p>','5','user1','2024-01-30 11:01:07',NULL,'乙肝疫苗（第一剂）-注射 或 乙肝疫苗（第二剂）-注射','0','[\"yg1\",\"yg2\"]','1060590974@qq.com','0',NULL,NULL,NULL,NULL,NULL),(59,5,'2','0','2','0','2024-01-17','2024-01-30',NULL,'16638808906','2',NULL,NULL,NULL,'4','user1','2024-01-30 11:09:53',NULL,'乙肝疫苗（第二剂）-注射','0','null','1060590974@qq.com','0',NULL,NULL,NULL,NULL,NULL),(60,5,'3','0','3','0','2024-01-24','2024-01-30','3','16638808906','3','<p>1</p>',NULL,NULL,'4','user1','2024-01-30 11:35:40',NULL,'乙肝疫苗（第一剂）-注射 或 乙肝疫苗（第二剂）-注射','0','[\"yg1\",\"yg2\"]','1060590974@qq.com','0',NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2024-01-30 11:37:55
